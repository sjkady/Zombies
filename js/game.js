...
var injured = function()
{
	...
	if(player.health>=0)
	{
		setTimeout(function(){hurtopacity-=0.2;}, 100);
		setTimeout(function(){hurtopacity-=0.2;}, 200);
		setTimeout(function(){hurtopacity-=0.2;}, 300);
		setTimeout(function(){hurtopacity-=0.2;}, 400);
		setTimeout(function(){hurtopacity-=0.2;}, 500);
	}
};
